...
%---
% Select endorsement page type. If want to use your own PDF file, use \printendorsementpdf, or if you want to use JPG file, use \printendorsementjpg, otherwise \printendorsement
%
\printendorsement
%\printendorsementpdf
